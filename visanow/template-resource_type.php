...
<section class="resource-detail uk-container uk-container-center">    	
	...
	<div class="resource-content uk-container uk-container-center uk-text-center">
		...
		<?php $taxs = get_terms('resource_type'); ?>
			<ul id="filters">  
 ...
 <div id="container" class="uk-grid box-modules">
	...
	<?php $args = array( 'post_type' => 'resource', 'posts_per_page' => 1, 'meta_key' => '_is_ns_featured_post', 'meta_value' => 'yes', 'taxonomy' => 'resource_type' ); ?>
	<?php
	...
	$id    =    $query->ID; 
	?>
	<?php $post_terms = wp_get_post_terms( $post->ID, 'resource_type' ); ?>
	<?php $isotope_class = ''; ?>
	...
	<?php endif; wp_reset_query(); ?>
		...
		<?php
		$args = array( 'post_type' => 'resource', 'posts_per_page' => -1, 'meta_key' => '_is_ns_featured_post', 'meta_compare' => 'NOT EXISTS', 'taxonomy' => 'resource_type' ); 
