    ...
    <em class="uk-hidden-small"><img src="<?php echo get_template_directory_uri(); ?>/images/up-arrow.png" alt=""></em>
	  ...
	  <div id="container" class="uk-grid box-modules">
		<div class="grid-sizer uk-width-medium-1-4"></div>
			...
			<?php $args = array( 'post_type' => 'post', 'posts_per_page' => 1, 'meta_key' => '_is_ns_featured_post', 'meta_value' => 'yes', 'taxonomy' => 'category' ); ?>
		  	<?php
			...
			<?php endforeach; ?>
			<?php $args = array( 'post_type' => 'post', 'posts_per_page' => -1, 'meta_key' => '_is_ns_featured_post', 'meta_compare' => 'NOT EXISTS', 'taxonomy' => 'category' ); ?>
			<?php
				$query = new WP_Query($args);
			...
			<div class="uk-width-large-1-4 bottom-gap item <?php echo $isotope_class; ?>">                
                <div class="box-content round-border">
                	<div class="fix-height stay_informed content-form uk-text-left">
