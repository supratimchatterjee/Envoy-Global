...
<section class="resource-detail uk-container uk-container-center">    	
	   ...
	   <?php $term_id = $tax->term_id; ?>  
	    ...
	    <div class="uk-grid box-modules" data-uk-grid="{controls: '#my-module'}">
            ...
            <?php endforeach; ?>
			 ...
			 <div class="uk-width-3-4 bottom-gap" data-uk-filter="<?php echo ltrim($isotope_class, ',');?>">
                ...
                <div class="box-content">
                	<div class="uk-grid">
                        ...
                        <div class="uk-width-3-10 featured_text">
    ...
    <div class="uk-width-1-4 bottom-gap" data-uk-filter="<?php echo ltrim($isotope_class, ',');?>">
                <div class="module-heading uk-text-left activated">
