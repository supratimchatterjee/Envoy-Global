...
<section class="resource-detail uk-container uk-container-center">    	
	...
	<div class="resource-content uk-container uk-container-center uk-text-center">
		...
		<div class="submenu-checkbox">
			<?php $taxs = get_terms('resource_category'); ?>
				<ul id="filters">  
		...
		<?php $args = array( 'post_type' => 'resource', 'posts_per_page' => 1, 'meta_key' => '_is_ns_featured_post', 'meta_value' => 'yes', 'taxonomy' => 'resource_category' ); ?>
		<?php
		...
		<?php $post_terms = wp_get_post_terms( $post->ID, 'resource_category' ); ?>
		<?php $isotope_class = ''; ?>
		...
		<?php
		$args = array( 'post_type' => 'resource', 'posts_per_page' => -1, 'taxonomy' => 'resource_category' ); 
		$query = new WP_Query($args);
